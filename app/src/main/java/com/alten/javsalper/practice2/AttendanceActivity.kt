...
class AttendanceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     //  val coordinatorLayout = findViewById<CoordinatorLayout>(com.google.android.material.R.id.coordinatorlayout)
       val studentPosition = intent.getIntExtra( "Posicion", 0)
     ...
     //  val colapsingtoolbar = findViewById<CollapsingToolbarLayout>(R.id.collapsingToolbar)
        ...
        textView.text= " "+ initializeStudents() [studentPosition+2].name+" "+ initializeStudents() [studentPosition+2].surname
     ...
     val studentPhoto = findViewById<ImageView>(R.id.imgAttendanceActivityUserView)
       ...
       // colapsingtoolbar.title = Student.creatUser() [StudentPosition].name + Student.creatUser()[StudentPosition].lastName
        Glide.with(studentPhoto.context)
            .load(initializeStudents()[studentPosition+2].photoUrl)
            .into(studentPhoto)

      /* Glide.whit(StudentPhoto.context) RequestManager
       .loadRequestBuilder Drawable
       //override( width: 400, height: 400)
       into(studentPhoto)*/
    ...
    private fun initializeStudents(): List<Student> {
        val  user = mutableListOf<Student>()
